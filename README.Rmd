...
super_cast <- readRDS("Data/super_cast.RDS")
...
Before I move on to the last step, I'd like to answer a couple more questions. First up, what performer has been in the most superhero movies? This question should be pretty easy to answer for any MCU fan.
...
Stan Lee has made a cameo in nearly every Marvel film with his last being <i>Avengers: Endgame</i>. His cameos were always a great touch in the films. The other performers below Mr. Lee in appearances makes sense except for one. Who is this Jimmy Star guy? If I dig a little deeper I might be able to find out.
